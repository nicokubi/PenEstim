...
mhChain_vMWG <- function(seed, n_iter, burn_in, chain_id, data, max_age, db,
    ...
    # Run the iterations of the adaptive MCMC algorithm
    # Combined with Metropolis-within-Gibbs 
    for (i in 1:n_iter) {
...
PenEstim_vMWG <- function(data, cancer_type, gene_input, n_chains = 4,
    ...
    parallel::clusterExport(cl, c(
        "mhChain_vMWG", "mhLogLikelihood_clipp", "calculate_lifetime_risk", "calculateNCPen",
