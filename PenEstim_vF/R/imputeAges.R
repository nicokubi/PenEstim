#' Draw Ages Using the Inverse CDF Method from SEER Data
#'
#' This function draws ages using the inverse CDF method from SEER data.
#'
#' @param seer_data A data frame containing SEER data with columns 'cum_prob' and 'age'.
#' @return A single age value drawn from the SEER data.
#' @export
...
#' status and sex using either Weibull, SEER, or empirical distribution.
#'
#' @param data A data frame containing the data.
#' @param na_indices A vector of indices indicating the rows in the data where ages need to be imputed.
#' @param SEER_male A data frame containing SEER data for males.
#' @param SEER_female A data frame containing SEER data for females.
