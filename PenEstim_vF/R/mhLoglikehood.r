...
#' data, genetic risk parameters, and allele frequencies.
#'
...
#' data, penetrances for carriers, and allele frequencies. It is designed to adjust penetrance estimates
...
#'
mhLogLikelihood_clipp <- function(paras, families, max_age, cancer_type, db, af, SeerNC, ncores) {
    paras <- unlist(paras)
    # Extract parameters
    gamma_male <- paras[1]
