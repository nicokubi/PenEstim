...
## Default Prior
In this simulation the penetrance estimation is applied to the first set of families from sim1.
The default prior settings are applied here with a uniform prior on the asymptote parameter. 
