...
system.time(out_sim_5.4 <- PenEstim_v3(
    data = dat,
    cancer_type = "Breast", gene_input = "BRCA1", n_chains = 1, n_iter_per_chain = 1000, 
    prior_params = prior_params_BRCA1, af = 0.1, burn_in = 0.1, median_max = FALSE
))
...
This application expands to the four parameter likelihood. Additionally the starting values for the chain are now based on the empirical analogues. 
...
# Run Estimation procedure with default prior setting 
# Main Estimation for Female
system.time(out_sim_5.4 <- PenEstim_v4(
    data = dat,
    cancer_type = "Breast", gene_input = "BRCA1", n_chains = 1, n_iter_per_chain = 5000, 
    prior_params = prior_params_default, af = 0.1, burn_in = 0.1, median_max = FALSE
))
save(out_sim_5.4, file = "out_sim_5.4.Rdata")
...
This application expands to the three parameter likelihood. The fix 
...
# Run Estimation procedure with default prior setting 
# Main Estimation for Female
system.time(out_sim_5.5 <- PenEstim_v4(
    data = dat,
    cancer_type = "Breast", gene_input = "BRCA1", n_chains = 1, n_iter_per_chain = 5, 
    prior_params = prior_params_default, af = 0.1, burn_in = 0.1, median_max = FALSE
))
...
plot_penetrance_sim(out_sim_5.5$combined_chains, prob = 0.95, max_age = 94,"Female",2.5,50,25,1)
...
# Run Estimation procedure with default prior setting 
# Main Estimation for Female
system.time(out_sim_5.6 <- PenEstim_v4(
    data = dat,
    cancer_type = "Breast", gene_input = "BRCA1", n_chains = 1, n_iter_per_chain = 5, 
    prior_params = prior_params_default, af = 0.1, burn_in = 0.1, median_max = FALSE
))
...
plot_penetrance_sim(out_sim_5.6$combined_chains, prob = 0.95, max_age = 94,"Female",2.5,50,20,0.5)
