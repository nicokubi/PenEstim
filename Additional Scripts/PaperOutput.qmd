...
calculate_penetrance <- function(data, ages = c(35, 50, 70), sex = "NA") {
...
# Example data
data <- list(
  median_male_results = c(60),
  first_quartile_male_results = c(45),
  threshold_male_results = c(30),
  asymptote_male_results = c(0.9),
  median_female_results = c(55),
  first_quartile_female_results = c(40),
  threshold_female_results = c(25),
  asymptote_female_results = c(0.8)
)

# Calculate penetrance results
penetrance_results <- calculate_penetrance(out_sim_COL_v9$combined_chains)
