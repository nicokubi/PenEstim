...
# Overwrite the penetetrane for all races, geneders and races
PanelPRODatabase$Penetrance[cancer_index, gene_index, race_index, , ,]<- penetrance.mod
...
median_true <- delta + beta * (-log((1-0.5)/1))^(1/alpha)
quartile_true <- delta + beta * (-log((1-0.25)/1))^(1/alpha)
print(median_true)
print(quartile_true)
...
PanelPRODatabase$Penetrance[cancer_index, gene_index, race_index, , ,] <- penetrance_mod_UC
