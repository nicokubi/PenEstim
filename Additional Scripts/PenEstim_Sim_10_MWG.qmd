...
system.time(out_sim_5.61 <- PenEstim_vMWG(
    data = dat,
    cancer_type = "Colorectal", gene_input = "MLH1", n_chains = 1, n_iter_per_chain = 4000, 
...
```{r corr2, echo=TRUE, cache=TRUE}
# Adjust the plot for male data
par(mfrow = c(2, 2))
plot(out_sim_5.61$combined_chains$median_male_results, 
     100 * out_sim_5.61$combined_chains$asymptote_male_results, 
     xlim = c(1, 100), 
     ylim = c(1, 100),
     xlab = "Median", 
     ylab = "Asymptote (Scaled)",
      main = "Correlation Plot - Male")

# Adjust the plot for female data
plot(out_sim_5.61$combined_chains$median_female_results, 
     100 * out_sim_5.61$combined_chains$asymptote_female_results, 
     xlim = c(1, 100), 
     ylim = c(1, 100),
     xlab = "Median", 
     ylab = "Asymptote (Scaled)",
     main = "Correlation Plot - Female")

plot(out_sim_5.61$combined_chains$first_quartile_male_results, 
     100 * out_sim_5.61$combined_chains$asymptote_male_results, 
     xlim = c(40, 80), 
     ylim = c(1, 100),
     xlab = "First Quartile", 
...
# Adjust the plot for female data
plot(out_sim_5.61$combined_chains$first_quartile_female_results, 
     100 * out_sim_5.61$combined_chains$asymptote_female_results, 
     xlim = c(40, 80), 
     ylim = c(1, 100),
     xlab = "First Quartile", 
